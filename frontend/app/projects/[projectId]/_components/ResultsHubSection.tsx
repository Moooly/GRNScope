...
export default function ResultsHubSection({ controls, children }: ResultsHubSectionProps) {
  return (
    <div className="mt-8 rounded-[1.5rem] border border-slate-200 bg-white/95 p-6 text-slate-900 shadow-[0_1px_2px_rgba(15,23,42,0.05)]">
      <div className="grid grid-cols-1 gap-x-4 gap-y-4 lg:grid-cols-[minmax(0,1fr)_auto]">
